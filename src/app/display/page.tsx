...
export default function DisplayBoard() {
  ...
  return (
    <div className=" bg-sky-50 flex flex-col items-center justify-center p-6">
      <h1 className="text-2xl font-bold text-sky-800 mb-4">PAYMENT 1</h1>
      <div className="w-full max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
          {counters
            .filter((c) => c.code.startsWith("P")) // filter to show only customer welfare
            .map((c) => (
              <div
                key={c.id}
