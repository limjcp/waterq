          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <button
                ...
                className="px-4 py-2 bg-sky-500 hover:bg-sky-800 text-white text-sm rounded-full transition-all duration-300 shadow-sm hover:shadow-md flex items-center"
              >
                <svg
