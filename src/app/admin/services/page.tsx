...
export default function ServicesManagement() {
  ...
  const [selectedService, setSelectedService] =
    useState<string>("");
  const [isAddingType, setIsAddingType] =
    useState(false);
  ...
  const [error, setError] = useState<
    string | null
  >(null);
  const [deletingTypeId, setDeletingTypeId] =
  ...
  const generateTypeCode = (
    ...
    const serviceInitial = service.name
      .charAt(0)
      .toUpperCase();
  ...
  const handleServiceChange = (
    ...
    const newCode = generateTypeCode(
      serviceId,
      newServiceType.name
    );
  ...
  const handleDeleteServiceType = async () => {
    if (!deletingTypeId || !deleteServiceId)
      return;
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 h-[93vh]">
          ...
          >
            <p className="text-gray-600 mb-6">
              ...
              service type? This action cannot be
              undone.
            </p>
            ...
            <form onSubmit={handleAddServiceType}>
              ...
              <div className="mb-6">
                ...
                <p className="mt-1 text-xs text-gray-500">
                  ...
                  based on service and type name
                </p>
              </div>
              <div className="flex justify-end gap-4">
                <Button
            ...
            >
              ...
              <div className="mb-6">
                ...
                <p className="mt-1 text-xs text-sky-600">
                  Use short codes like CW for
                  Customer Welfare, A for
                  Application, etc.
                </p>
              </div>
              <div className="flex justify-end gap-4">
